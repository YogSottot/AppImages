...
delete_blacklisted()
{
  BLACKLISTED_FILES=$(cat_file_from_url https://raw.githubusercontent.com/YogSottot/AppImages/empty-exclude/excludelist | sed 's|#.*||g')
...
generate_status()
{
  ...
  wget -q -c "https://raw.githubusercontent.com/YogSottot/AppImages/empty-exclude/excludedeblist"
